...
console.log('Tests de Deep Equal:')

// Diferentes tipos
console.log('Number comparado con sí mismo:', deepEqual(1, 1)) // true
console.log('Number comparado con string:', deepEqual(1, '1')) // false

// Diferentes valores
console.log('Strings distintos:', deepEqual('2', '1')) // false
console.log('Numbers distintos:', deepEqual(41, 3)) // false

// Objetos idénticos
console.log('Objeto almacenado comparado con sí mismo:', deepEqual(john, john)) // true
console.log('Objetos iguales:', deepEqual(john, {firstName: 'John',lastName: 'Doe'})) // true

// Objetos distintos
console.log('Objetos con propiedades distintas:', deepEqual(john, mark)) // false
console.log('Objetos con distinta cantidad de propiedades:', deepEqual(john, {firstName: 'John'})) // false
...
console.log('\n\nTests de Chunk (array original de 8):')

console.log('Arrays de 1:', chunk(data, 1)) // [[1], [2], [3], [4], [5], [6], [7], [8]]
console.log('Arrays de 2:', chunk(data, 2)) // [[1, 2], [3, 4], [5, 6], [7, 8]]
console.log('Arrays de 3:', chunk(data, 3)) // [[1, 2, 3], [4, 5, 6], [7, 8]] 
console.log('Arrays de 4:', chunk(data, 4)) // [[1, 2, 3, 4], [5, 6, 7, 8]] 
console.log('Arrays de 5:', chunk(data, 5)) // [[1, 2, 3, 4, 5], [6, 7, 8]]
console.log('Arrays de 10:', chunk(data, 10)) // [[1, 2, 3, 4, 5, 6, 7, 8]]
...
console.log('"cccbbbaaa" tiene: ', frequency('cccbbbaaa')) // {a: 3, b: 3, c: 3}
console.log('"www.bedu.org" tiene: ', frequency('www.bedu.org')) // {.: 2, b: 1, d: 1, e: 1, g: 1, o: 1, r: 1, u: 1, w: 3}
console.log('"john.doe@domain.com" tiene: ', frequency('john.doe@domain.com')) // {.: 2, @: 1, a: 1, c: 1, d: 2, e: 1, h: 1, i: 1, j: 1, m: 2, n: 2, o: 4}
console.log('"94893475690586" tiene: ', frequency('94893475690586')) // { '0': 1, '3': 1, '4': 2, '5': 2, '6': 2, '7': 1, '8': 2, '9': 3 }
console.log('"9489ssssoo8$6iio///vvvvvv&&" tiene: ', frequency('9489ssssoo8$6iio///vvvvvv&&')) // { '4': 1, '6': 1, '8': 2, '9': 2, '$': 1, '&': 2, '/': 3, i: 2, o: 3, s: 4, v: 6 }
